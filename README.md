...
- 최신: v1.1.2
- Windows (포터블 실행파일):
  - `DocumentMaskerOCR_windows_portable_v1.1.2.zip`
- macOS (Python 소스 실행 번들):
  - `DocumentMaskerOCR_mac_python_bundle_v1.1.2.zip`
- 릴리즈 페이지:
  - https://github.com/galvaomica396/mask-tool-ocr-public/releases/tag/v1.1.2
